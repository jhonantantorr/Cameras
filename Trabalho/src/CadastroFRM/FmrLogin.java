...
public class FmrLogin extends javax.swing.JFrame {
    ...
    public FmrLogin() throws ClassNotFoundException {
        initComponents();
...
public void Logar(){
    ...
    try{
        ...
        if(rs.next()){
            ...
            JOptionPane.showConfirmDialog(null, "Usuáriou ou senha inválida");
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icones/user_go.png"))); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icones/key.png"))); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icones/user_green.png"))); // NOI18N
